...
✅ 중요: 이 실행은 “누수 방지 검사(label shuffle)”도 같이 돌도록 되어 있습니다.
즉, `label_shuffle_auc ≈ 0.50`이 같이 나오면 “치팅 없이 평가했다”는 최소 신뢰가 생깁니다.
...
방금 쇼핑을 많이 했으면 → 쇼핑 광고를 더 누를 수 있음
